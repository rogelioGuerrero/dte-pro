                  ...
                  <div className="space-y-5">
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="lmstudio">LM Studio (local/ngrok)</option>
                      </select>
                    ...
                    <div className="space-y-4">
                      ...
                      {(settings.aiProvider || 'gemini') === 'lmstudio' && (
                        <div className="space-y-4">
                          <div>
                            <label className="block text-xs font-semibold text-gray-600 mb-1.5">LM Studio URL (ngrok)</label>
                            <input
                              type="text"
                              ...
                              autoComplete="off"
                            />
                            <p className="text-xs text-gray-400 mt-1">URL de tu servidor LM Studio expuesto vía ngrok</p>
                          </div>
                          <div>
                            <label className="block text-xs font-semibold text-gray-600 mb-1.5">LM Studio API Key</label>
                            <input
                              type="password"
                              ...
                              autoComplete="off"
                            />
                            <p className="text-xs text-gray-400 mt-1">API Key configurada en LM Studio (opcional)</p>
                          </div>
                          <div>
                      ...
                      <div>
                        <label className="block text-xs font-semibold text-gray-600 mb-1.5">GNews API Key <span className="text-gray-400 font-normal">(noticias desde browser)</span></label>
                        <input
                          type="password"
