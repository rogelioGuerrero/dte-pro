  ...
  definitions: {
    ...
    CCFE: {
      ...
      properties: {
        ...
        documentoRelacionado: { type: ['object', 'null'] },
        emisor: { $ref: 'dte-schema-root#/definitions/FE/properties/emisor' },
        receptor: { $ref: 'dte-schema-root#/definitions/ReceptorCCF' },
        otrosDocumentos: { type: ['object', 'null'] },
        ventaTercero: { type: ['object', 'null'] },
    ...
    FEXE: {
      ...
      properties: {
        ...
        documentoRelacionado: { type: ['object', 'null'] },
        emisor: { $ref: 'dte-schema-root#/definitions/FE/properties/emisor' },
        receptor: { $ref: 'dte-schema-root#/definitions/FE/properties/receptor' },
        otrosDocumentos: { type: ['object', 'null'] },
        ventaTercero: { type: ['object', 'null'] },
        cuerpoDocumento: { $ref: '#/definitions/CuerpoDocumento' },
        resumen: { $ref: '#/definitions/Resumen' },
