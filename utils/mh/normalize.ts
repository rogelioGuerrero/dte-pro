...
export const normalizeDTE = (dte: DTEJSON): DTEJSON => {
  ...
  return {
    ...
    receptor: {
      ...
      ...(Object.prototype.hasOwnProperty.call(dte.receptor, 'correo')
        ? {
    ...
    resumen: {
      ...
      ivaPerci1: roundTo(dte.resumen.ivaPerci1 ?? 0, 2),
      ...
      condicionOperacion: dte.resumen.condicionOperacion,
      pagos: dte.resumen.pagos,
      numPagoElectronico: dte.resumen.numPagoElectronico ?? null,
    },
